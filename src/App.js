...
const PROJECTS = [
  ...
  },
  {
    ...
    metrics: ["Full Stack", "Health & Wellness","14+ API Endpoints", "4 Core Modules"],
    stack: ["React", "Java", "Spring Boot", "REST API"],
  },
  {
    num: "03", accent: "#fbbf24",
    title: "HPE — RESTful Employee Service",
    desc: "Wrote a proposal for a RESTful web service to manage a list of employees. Built a Java Spring Boot server accepting and responding to HTTP requests with JSON data upload support. Developed and ran unit tests to assess application performance.",
    metrics: ["Forage · HPE", "Spring Boot REST"],
    stack: ["Java", "Spring Boot", "REST API", "JUnit", "JSON"],
    badge: "Forage Virtual",
  },
  {
    num: "04", accent: "#34d399",
    title: "Wells Fargo — Portfolio Management ERD",
    desc: "Understood requirements for a financial portfolio management system, identified the data entities needed, and drafted a full entity relationship diagram. Implemented the ERD using IntelliJ and published the design to GitHub.",
    metrics: ["Forage · Wells Fargo", "System Design"],
    stack: ["ERD", "IntelliJ", "GitHub", "Data Modeling"],
    badge: "Forage Virtual",
  },
  {
    num: "05", accent: "#f87171",
    title: "Walmart — Heap & UML Design",
    desc: "Developed a novel heap data structure in Java for Walmart's shipping department. Designed a UML class diagram for a multi-mode data processor and created an ERD for Walmart's pet department database based on business requirements.",
    metrics: ["Forage · Walmart", "Algorithms & Design"],
    stack: ["Java", "Data Structures", "UML", "ERD", "Algorithms"],
    badge: "Forage Virtual",
  },
  {
    num: "06", accent: "#c084fc",
    title: "Accenture — Agile Spring Boot CI/CD",
    desc: "Supported a client dev team overwhelmed by codebase growth. Wrote a Java Spring Boot search class for an interactive website, set up Jenkins CI/CD for automated builds on every push, and led an Agile sprint planning session with user stories.",
    metrics: ["Forage · Accenture", "CI/CD · Agile"],
    stack: ["Java", "Spring Boot", "Jenkins", "Agile", "CI/CD"],
    badge: "Forage Virtual",
  },
];
